package com.talentops.domain.job.entity;

import com.talentops.domain.company.entity.CompanyEntity;
import com.talentops.domain.user.entity.UserEntity;
import com.talentops.domain.user.entity.UserProfileEntity;
